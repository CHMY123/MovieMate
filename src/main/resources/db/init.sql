...
VALUES
('克里斯托弗·诺兰', 0, '1970-07-30', '英国导演、编剧、制片人，代表作《盗梦空间》《星际穿越》等'),
('詹姆斯·卡梅隆', 0, '1954-08-16', '加拿大导演、编剧，代表作《泰坦尼克号》《阿凡达》等');

-- 插入测试演员
INSERT INTO `tb_actor` (`actor_name`, `gender`, `birth_date`, `intro`)
VALUES
('莱昂纳多·迪卡普里奥', 0, '1974-11-11', '美国演员、制片人，代表作《泰坦尼克号》《盗梦空间》等'),
('凯特·温斯莱特', 1, '1975-10-05', '英国演员，代表作《泰坦尼克号》《朗读者》等'),
('马修·麦康纳', 0, '1969-11-04', '美国演员，代表作《星际穿越》《达拉斯买家俱乐部》等');

-- 插入测试电影
INSERT INTO `tb_movie` (`movie_name`, `movie_type`, `region`, `director_id`, `release_time`, `score`, `view_count`, `is_vip`, `cover_img`, `description`)
VALUES
('泰坦尼克号', '爱情/灾难', '美国', 2, '1997-12-19', 9.1, 1234567, 0, 'https://example.com/titanic.jpg', '一部跨越阶级的爱情悲剧，以泰坦尼克号沉船事件为背景'),
('盗梦空间', '科幻/悬疑', '美国', 1, '2010-07-16', 8.8, 987654, 1, 'https://example.com/inception.jpg', '一部关于梦境与现实的科幻电影，探讨人类潜意识的奥秘'),
('星际穿越', '科幻/冒险', '美国', 1, '2014-11-07', 9.0, 876543, 1, 'https://example.com/interstellar.jpg', '一部关于时空旅行和人类未来的科幻巨作');
